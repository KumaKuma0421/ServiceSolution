//
// @sa https://docs.microsoft.com/en-us/windows/win32/eventlog/querying-for-event-source-messages
//

#include "pch.h"

#define PROVIDER_NAME           L"ServiceApplication1"
#define RESOURCE_DLL            L"C:\\Users\\User01\\source\\repos\\ServiceSolution\\x64\\Debug\\ServiceMessage.dll"
...
CONST LPWSTR pEventTypeNames[] = { (LPTSTR)_T("Error"), (LPTSTR)_T("Warning"), (LPTSTR)_T("Informational"), (LPTSTR)_T("Audit Success"), (LPTSTR)_T("Audit Failure") };
