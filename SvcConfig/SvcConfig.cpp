...
int __cdecl _tmain(int argc, TCHAR *argv[])
{
    ...
    if( argc != 3 )
    {
        ...
        DisplayUsage();
        return ERROR_INVALID_PARAMETER; // add "ERROR_INVALID_PARAMETER" by me.
    }
...
VOID __stdcall DoQuerySvc()
{
    ...
    LPQUERY_SERVICE_CONFIG lpsc = NULL; // add "= NULL" by me.
    LPSERVICE_DESCRIPTION lpsd = NULL; // add "= NULL" by me.
...
VOID __stdcall DoUpdateSvcDesc()
{
    ...
    LPTSTR szDesc = (LPTSTR)TEXT("This is a test description"); // add "(LPTSTR)" by me.
...
VOID __stdcall DoDeleteSvc()
{
    SC_HANDLE schSCManager;
    SC_HANDLE schService;
    //SERVICE_STATUS ssStatus; commented by me.
